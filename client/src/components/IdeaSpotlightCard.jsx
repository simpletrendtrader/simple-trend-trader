...
export default function IdeaSpotlightCard({ idea }) {
  return (
    <div className="glass-panel panel-depth rounded-[2rem] p-6 transition hover:-translate-y-1 hover:border-neon/30 hover:shadow-glow">
      ...
      <p className="editorial-kicker mt-4 text-2xl text-slate-200">"{idea.bias}"</p>
