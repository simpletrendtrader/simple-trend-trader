...
import { ArrowRight, ChartNoAxesCombined, GraduationCap, NotebookPen, Radar } from 'lucide-react';
...
import { featuredIdeas, lessonTracks, pillars, stats } from '../data/siteContent.js';
...
export default function LandingPage() {
  return (
    <div className="px-2 py-10">
      <section className="grid gap-10 lg:grid-cols-[1.08fr,0.92fr] lg:items-center">
        <div>
          ...
          <h1 className="mt-6 max-w-5xl font-display text-5xl font-semibold leading-tight text-white md:text-7xl">
      ...
      <section className="mt-12 grid gap-10 lg:grid-cols-[0.92fr,1.08fr] lg:items-center">
        <div className="glass-panel rounded-[2rem] p-8 shadow-gold">
