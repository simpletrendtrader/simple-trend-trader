  ...
  return (
    <div className="px-2 py-10">
      <SectionTitle
        ...
        description="This section now supports real YouTube lessons. To update it, edit the lesson title, description, and video URL inside client/src/data/youtubeLessons.js."
      />
